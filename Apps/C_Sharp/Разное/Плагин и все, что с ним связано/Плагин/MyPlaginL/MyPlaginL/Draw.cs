...
{
    [PluginForLoad(true)]
    public class MyPlaginL :
                 IToolPaintPlugin
    {
        private IPaintPluginContext pluginContext = null;
        private Eraser optionsControl = null;
        ...
        public void AfterCreate(IPaintPluginContext pluginContext)
        {
            ...
            optionsControl = new Eraser(ApplicationContext);
            ...
            if (imageDir != null)
            {
                ...
                try
                {
                    cursor = new Cursor(imageDir + "eraser.png");
                }
                catch { }
            }
        }
        ...
        public void MouseMove(MouseEventArgs me, Keys modifierKeys)
        {
            if (flag)
            {
                ...
                graphics.DrawEllipse(pen, P(me).X, P(me).Y, 5, 5);
